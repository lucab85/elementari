...
const styles = StyleSheet.create({
  ...
  questionText: { fontSize: 22, fontWeight: '700', color: COLORS.text, textAlign: 'center', lineHeight: 30 },
  ...
  options: { gap: 10 },
  optionBtn: { backgroundColor: COLORS.white, borderRadius: 16, padding: 16, alignItems: 'center', borderWidth: 2, borderColor: ENG_LIGHT },
